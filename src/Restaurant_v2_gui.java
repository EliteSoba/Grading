...
public class Restaurant_v2_gui extends JFrame implements ActionListener {
	...
	private void setUpDesign() {
		...
		Item Design[] = new Item[12];		
		Design[0] = new Item(2, "Host - The messages/scheduler/actions paradigm is used properly.", "Host Design");
		Design[1] = new Item(1, "Host - Pseudo-code is consistent with the Interaction Diagram.","Host Design");
		Design[2] = new Item(2, "Host - Pseudo-code is descriptive and easy to understand.", "Host Design");		
		Design[3] = new Item(2, "Cook - The messages/scheduler/actions paradigm is used properly.", "Cook Design");
		Design[4] = new Item(1, "Cook - Pseudo-code is consistent with the Interaction Diagram.","Cook Design");
		Design[5] = new Item(2, "Cook - Pseudo-code is descriptive and easy to understand.", "Cook Design");		
		Design[6] = new Item(2, "Waiter - The messages/scheduler/actions paradigm is used properly.", "Waiter Design");
		Design[7] = new Item(1, "Waiter - Pseudo-code is consistent with the Interaction Diagram.","Waiter Design");
		Design[8] = new Item(2, "Waiter - Pseudo-code is descriptive and easy to understand.", "Waiter Design");		
		Design[9] = new Item(2, "Customer - The messages/scheduler/actions paradigm is used properly.", "Customer Design");
		Design[10] = new Item(1, "Customer - Pseudo-code is consistent with the Interaction Diagram.","Customer Design");
		Design[11] = new Item(2, "Customer - Pseudo-code is descriptive and easy to understand.", "Customer Design");
	...
	public static void main(String[] args) {
		Restaurant_v2_gui test = new Restaurant_v2_gui();
	}
